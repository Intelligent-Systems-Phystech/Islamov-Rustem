...
\begin{figure}[t]
	\begin{center}
		\centerline{\begin{tabular}{cccc}
				\includegraphics[width = 0.23 \textwidth]{LogReg/a9a/Lambda=1e-3/a9a_nl_bfgs_bits_lmb=0_001.pdf}&
				\includegraphics[width = 0.23 \textwidth]{LogReg/a9a/Lambda=1e-4/a9a_nl_bfgs_bits_lmb=0_0001.pdf}&
				\includegraphics[width = 0.23 \textwidth]{LogReg/w8a/Lambda=1e-3/w8a_nl_bfgs_bits_lmb=0_001.pdf}&
				\includegraphics[width = 0.23 \textwidth]{LogReg/phishing/Lambda=1e-5/phishing_nl_bfgs_bits_lmb=0_00001.pdf}
				\\
...
\begin{figure}[t]
	\begin{center}
		\centerline{\begin{tabular}{cccc}
				\includegraphics[width = 0.23 \textwidth]{LogReg/a9a/Lambda=1e-3/a9a_nl_adiana_bits_lmb=0_001.pdf}&
				\includegraphics[width = 0.23 \textwidth]{LogReg/a9a/Lambda=1e-4/a9a_nl_adiana_bits_lmb=0_0001.pdf}&
				\includegraphics[width = 0.23 \textwidth]{LogReg/w8a/Lambda=1e-3/w8a_nl_adiana_bits_lmb=0_001.pdf}&
				\includegraphics[width = 0.23 \textwidth]{LogReg/phishing/Lambda=1e-5/phishing_nl_adiana_bits_lmb=0_00001.pdf}
				\\
				(a) {\tt a9a}, $\lambda=10^{-3}$ &(b) {\tt a9a}, $\lambda=10^{-4}$ & (c) {\tt w8a}, $\lambda=10^{-3}$ &(d) {\tt phishing}, $\lambda=10^{-5}$\\
				\includegraphics[width = 0.23 \textwidth]{LogReg/a7a/Lambda=1e-3/a7a_nl_adiana_bits_lmb=0_001.pdf}&
				\includegraphics[width = 0.23 \textwidth]{LogReg/a7a/Lambda=1e-4/a7a_nl_adiana_bits_lmb=0_0001.pdf}&
				\includegraphics[width = 0.23 \textwidth]{LogReg/phishing/Lambda=1e-3/phishing_nl_adiana_bits_lmb=0_001.pdf}&
				\includegraphics[width = 0.23 \textwidth]{LogReg/phishing/Lambda=1e-4/phishing_nl_adiana_bits_lmb=0_0001.pdf}
				\\
